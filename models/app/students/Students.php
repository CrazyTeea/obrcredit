...
class Students extends ActiveRecord
{
    ...
    public static function getOsnovanie()
    {
        return [
            ...
            'Смерть заёмщика, либо безвестно отсутствующий'
        ];
    }
