        ...
        <?php else: ?>
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" readonly="" id="num_name" class="form-control"
                           value="<?= $model->numberPP->number ?>">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="bank_name" class="control-label">Банк</label>
                    <input type="text" readonly="" id="bank_name" class="form-control"
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th colspan="4"><p class="text-center">Пролонгация льготного периода пользования <br> образовательным
                        кредитом</p></th>
                <td rowspan="3"><p class="text-sm-center">Выпускник (завершено обучение в образовательной
                        организации)</p></td>
            </tr>
            <tr>
                ...
                <td rowspan='2'><p class="text-sm-center">Отсрочка льготного периода <br> в связи с предоставлением
                    ...
                    <br>
                    <button type="button" href="#clean2"> Сброс</button>
                </td>
            ...
            <tr>
                ...
                <td>Основание <br>
                    <button type="button" href="#clean"> Сброс</button>
                </td>
            ...
            <tr>
                <td>
                    пункт 1 части 2 статьи 61 Федерального закона № 273-ФЗ <br><br>
                    <?= $form->field($model, 'osnovanie')->radio([
