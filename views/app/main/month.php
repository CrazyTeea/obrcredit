                            ...
                            <div class="caption">
                                ...
                                <?php if ($student699):?>
                                    <p>
                                        ...
                                        <button id="<?=($student699->status==2 ) ? 'green' :  'red'  ?>" type="button" class="btn btn-block btn-lg" data-toggle="modal" data-target="#myModal<?=$month?>699">
                                ...
                                <?php if ($student1026):?>
                                    <p>
                                        ...
                                        <button id="<?=($student1026->status==2 ) ? 'green' :  'red' ?>" type="button" class="btn btn-block btn-lg" data-toggle="modal" data-target="#myModal<?=$month?>1026">
